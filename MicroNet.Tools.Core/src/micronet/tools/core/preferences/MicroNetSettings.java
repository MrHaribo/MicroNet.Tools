	...
	public void createFieldEditors() {
		addField(
			new BooleanFieldEditor(
				PreferenceConstants.P_USE_DOCKER_TOOLBOX,
				"&Use Docker Toolbox",
				getFieldEditorParent()));

		addField(new DirectoryFieldEditor(PreferenceConstants.P_DOCKER_TOOLBOX_PATH, 
				"&Docker Toolbox Directory:", getFieldEditorParent()));
